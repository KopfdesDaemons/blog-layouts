...
?>
    <div class="blog_layouts_stackoverflow_header_content">
        <div class="blog_layouts_stackoverflow_mobile_toggle_button_container">
            <button id="blog_layouts_mobile_menu_toggle_button">
                <i class="fa-solid fa-bars"></i>
            </button>
            <div id="blog_layouts_header_mobile_menu">
                <ul class="blog_layouts_stackoverflow_header_mobile_icons">
                    <li>
                        <a href="<?php echo esc_url(get_theme_mod('stackoverflow_icon_1_link', 'x')) ?>">
                            <i class="<?php echo esc_attr(get_theme_mod('stackoverflow_icon_1', 'fa-solid fa-inbox')) ?>"></i>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(get_theme_mod('stackoverflow_icon_2_link', '')) ?>">
                            <i class="<?php echo esc_attr(get_theme_mod('stackoverflow_icon_2', 'fa-solid fa-trophy')) ?>"></i>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(get_theme_mod('stackoverflow_icon_3_link', '')) ?>">
                            <i class="<?php echo esc_attr(get_theme_mod('stackoverflow_icon_3', 'fa-solid fa-circle-question')) ?>"></i>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url(get_theme_mod('stackoverflow_icon_4_link', '')) ?>">
