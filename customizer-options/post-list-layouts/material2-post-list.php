...
function lime_blog_material2_post_list($wp_customize)
{
    ...
    // Posts Spacing
    $wp_customize->add_setting('material2_post_list_spacing', array(
        'default' => '3',
        'transport' => 'refresh',
    ...
    $wp_customize->add_setting('material2_post_list_words_in_snippet', array(
        'default' => 30,
        'sanitize_callback' => 'absint',
    ));
    ...
    // Line height
    $wp_customize->add_setting('material2_post_list_line_height', array(
        'default' => '20',
        'transport' => 'refresh',
        'sanitize_callback' => 'absint',
    ));
