<?php
function lime_blog_material3_post_list($wp_customize)
{
    // Background color
    ...
    // Categorys
    $wp_customize->add_setting('material3_post_list_categorys', array(
        'default' => true,
        'transport' => 'refresh',
        'sanitize_callback' => 'lime_blog_sanitize_checkbox',
    ));

    $wp_customize->add_control('material3_post_list_categorys', array(
        'type' => 'checkbox',
...
add_action('customize_register', 'lime_blog_material3_post_list');

// Number of words previewed in the feed
function lime_blog_material3_custom_excerpt_length($length)
{
    return get_theme_mod('material3_post_list_words_in_snippet', 30);
}
add_filter('excerpt_length', 'lime_blog_material3_custom_excerpt_length', 999);
