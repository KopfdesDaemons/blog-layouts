...
<main>
    ...
    while (have_posts()) :
        the_post();
    ?>
        <section class="clean_space_content_spacer clean_space_content_spacer_post" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <div class="clean_space_content_and_sidebar_grid">
